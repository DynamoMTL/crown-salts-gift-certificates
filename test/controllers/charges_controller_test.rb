...
class ChargesControllerTest < ActionController::TestCase
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post :create, charge: { card_id: @charge.card_id, description: @charge.description, refunded: @charge.refunded, stripe_token: @charge.stripe_token }
    end
  ...
  test "should update charge" do
    patch :update, id: @charge, charge: { card_id: @charge.card_id, description: @charge.description, refunded: @charge.refunded, stripe_token: @charge.stripe_token }
    assert_redirected_to charge_path(assigns(:charge))
  end
